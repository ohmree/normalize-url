...
test('main', (t) => {
  ...
  t.is(
    normalizeUrl('http://sindresorhus.com/foo#bar:~:text=hello%20world', {
      stripHash: true,
    }),
    'http://sindresorhus.com/foo',
  );
...
test('stripTextFragment option', (t) => {
  t.is(normalizeUrl('http://sindresorhus.com'), 'http://sindresorhus.com');
  t.is(
    normalizeUrl('http://sindresorhus.com/about#'),
  ...
  t.is(
    normalizeUrl('http://sindresorhus.com/about#main'),
...
test('removeSingleSlash option', (t) => {
  ...
  t.is(
    normalizeUrl('https://sindresorhus.com', options),
    'https://sindresorhus.com',
  );
  t.is(
    normalizeUrl('https://sindresorhus.com/', options),
...
test('data URL', (t) => {
  ...
  t.is(
    normalizeUrl('data:,sindresorhus.com?foo=bar&a=a&utm_medium=test', options),
